...
than by heartbeats, and client authentication widens that gap: the payload grew from 87
to 265~B and the handshake carries a certificate each way. The gateway pins TLS~1.2 to the
