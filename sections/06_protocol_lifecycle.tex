...
\midrule
Enrollment & Device identifier, firmware/runtime descriptor, the announced public key, and the gateway nonce with the device's signature over it & The gateway binds the transport session to the expected \texttt{Device} resource only once that signature verifies, and before reporting connectivity. \\
