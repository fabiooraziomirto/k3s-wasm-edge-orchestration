...
% Removed: Application & Target device, WASM artifact, desired execution state & Deployment phase, start outcome, execution result or error evidence \\
\texttt{Application} & Target device, WASM artifact, desired execution state & Deployment phase, start outcome, execution result or error evidence \\
