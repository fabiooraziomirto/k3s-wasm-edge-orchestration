...
% TODO before submission: set the canonical repository URL (placeholder below points nowhere final) and tag the evaluated revision.
The source code and deployment assets associated with the framework are maintained in the public project repository \href{https://github.com/TODO-set-repository-url}{\nolinkurl{TODO-set-repository-url}}. \revC{The exact revision evaluated in this paper is tagged \texttt{v1.0}, so that the results can be reproduced from a fixed snapshot rather than from a moving branch.}
